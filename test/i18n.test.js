...
import { negotiateLocale, parseTag } from "../public/js/i18n/negotiate.js";

const pick = (requested) => negotiateLocale(requested, localeCodes, FALLBACK_LOCALE);
...
describe("로케일 파일", () => {
  ...
  const requiredFunctions = ["appName", "adjustedBy", "rateLimited", "aboutLines"];
